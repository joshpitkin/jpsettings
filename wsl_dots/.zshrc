...
export EDITOR=nvim
export NODE_EXTRA_CA_CERTS=/usr/local/share/ca-certificates/microncert.crt

# Path to your oh-my-zsh installation.
export ZSH="/home/jpitkin/.oh-my-zsh"
...
plugins=(git docker zsh-syntax-highlighting zsh-autosuggestions zsh-completions)
# plugins=(git)
